...
@section('title', 'รายละเอียดร้านคาเฟ่ - CafeHeal')
    ...
    <div>
        <div class="text-sm breadcrumbs ml-3 mb-2">
            <ul>
                ...
                <li class="text-blue-500 font-bold">รายละเอียดร้านคาเฟ่</li>
            </ul>
        </div>
        <h1 class="font-bold text-2xl ml-3">รายละเอียดร้านคาเฟ่</h1>
        ...
        <div class="card w-100 bg-base-100 shadow-xl">
            <div class="container mx-auto flex flex-col py-6">
                <div class="hidden w-full h-screen lg:h-[500px] lg:grid grid-cols-4  gap-4 px-3 lg:px-0">
                    ...
                    <!-- Article Image Main -->
                    <div class="relative w-full col-span-4 lg:col-span-2 order-1" data-aos="zoom-in"
                ...
                <div class="grid lg:hidden gap-4 px-3 lg:px-0">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        <div>
                            <img class="h-full max-w-full hover:opacity-75"
                                src="/uploads/{{ $cafe->cafeGallery->subimage_1 }}" alt="">
                        </div>
                        <div>
                            <img class="h-full max-w-full hover:opacity-75"
                                src="/uploads/{{ $cafe->cafeGallery->subimage_2 }}" alt="">
                        </div>
                        <div>
                            <img class="h-full max-w-full hover:opacity-75"
                                src="/uploads/{{ $cafe->cafeGallery->subimage_3 }}" alt="">
                        </div>
                        <div>
                            <img class="h-full max-w-full hover:opacity-75"
                                src="/uploads/{{ $cafe->cafeGallery->subimage_4 }}" alt="">
                        </div>
                    </div>
                </div>

                <!-- Post Section -->
                <section class="w-full grid grid-cols-1 xl:grid-cols-3 gap-4 px-3 shadow">
                    <article class="w-full flex flex-col md:col-span-2 my-4">
                        <div class="bg-white flex flex-col justify-start p-6">
                            ...
                            <h1 class="text-2xl font-bold pb-3">รีวิว/ให้คะแนนร้าน</h1>
                            <p class="pb-3">Donec vulputate auctor leo lobortis congue. Sed elementum pharetra turpis.
                                Nulla
                                at
                                ...
                                neque,
                                vitae efficitur felis vestibulum sagittis. Nunc a eros aliquet, egestas tortor hendrerit,
                                posuere
                                diam. Proin laoreet, ligula non eleifend bibendum, orci nulla luctus ipsum, dignissim
                                convallis
                                quam
                                dolor et nulla.</p> --}}
                        </div>
